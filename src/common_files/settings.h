...
#define XY_VEL_MAX  0.05
#define Z_VEL_MAX   0.05

// Flight Settings
#define TAKE_OFF_HEIGHT 0.85f
#define INITIAL_DESIRED_FLYING_COPTERS 0
#define CHARGED_FOR_TAKEOFF_VOLTAGE 3.0f
...
#define REACHED_WP_TIMEOUT        15000 //ms
...
// NOTE: Broadcasting Frequency
#define BROADCAST_FREQUENCY_HZ 2
#define CALC_NEXT_FREQUENCY_HZ 3

#define SNIFFER_PRINT_FREQUENCY_HZ 1

// NOTE: phryctoria
#define SLICER_FREQUENCY_HZ 3
#define ABSTRACTOR_FREQUENCY_HZ 3
#define BROADCAST_TOKEN_FREQUENCY_HZ 1

#define ALIVE_TIMEOUT_MS 8000 //ms after not receiving data from a copter ,it is considered dead
...
#define MIN_Y_BOUND -1.4f
#define MAX_Y_BOUND  1.4f
...
#define SLICER_PERIOD_MS (1000 / SLICER_FREQUENCY_HZ)
#define ABSTRACTOR_PERIOD_MS (1000 / ABSTRACTOR_FREQUENCY_HZ)
#define SNIFFER_PRINT_PERIOD_MS (1000 / SNIFFER_PRINT_FREQUENCY_HZ)
#define BROADCAST_TOKEN_PERIOD_MS (1000 / BROADCAST_TOKEN_FREQUENCY_HZ)
